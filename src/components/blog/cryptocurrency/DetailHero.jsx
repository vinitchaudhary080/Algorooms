...
export default function DetailHero({
  backTo = "/blog",
  category = "Building Waelth",
  title = "Building Wealth with an Algo Trading Platform: The Modern Approach",
  excerpt = "The world of investing is no longer limited to charts, gut feelings, or long hours of manual trading. In 2025, wealth creation has taken a smarter turn — led by technology, data, and automation. At the center of this transformation is the Algo Trading Platform, redefining how traders and investors build long-term wealth with precision and control.",
