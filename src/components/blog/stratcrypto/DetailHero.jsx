...
export default function CodeDetailHero({
  ...
  excerpt = "Crypto trading is just like buying and selling anything else—except here, you’re dealing with digital money. You buy coins when the price is low and sell when it’s higher.",
  date = "Sep 16, 2025",
